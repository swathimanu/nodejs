...
Server.prototype.setOptions = function(options) {
  ...
  if (options.sessionIdContext) {
    ...
    /* TODO: stefanmb investigate a less heavy handed approach, note that OpenSSL will only accept
     * 128 bits (SSL_MAX_SID_CTX_LENGTH is definde to 32 * 4 = 128), so we have to truncate 
     * Food for thought: http://stackoverflow.com/a/14869745
     * */
    if (crypto.hasFipsCryptoProvider) {
